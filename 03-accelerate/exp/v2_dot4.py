    ...
    for (int qb = 0; qb < q_count; qb += block) {
        ...
        for (int c = 0; c < c_count; ++c) {
            ...
            for (; q + 3 < qe; q += 4) {
                ...
                float32x4_t r4d = vdupq_n_f32(0.0f);
                float32x4_t p4d = vdupq_n_f32(0.0f);
                int d = 0;
                for (; d + 3 < dimension; d += 4) {
                    const float32x4_t x0 = vld1q_f32(xt + (size_t)d * stride + q);
                    ...
                    const float32x4_t a0 = vsubq_f32(x0, vdupq_n_f32(center[d]));
                    ...
                    r4  = vfmaq_f32(r4,  a0, a0); p4  = vfmaq_f32(p4,  x0, vdupq_n_f32(direction[d]));
                    r4b = vfmaq_f32(r4b, a1, a1); p4b = vfmaq_f32(p4b, x1, vdupq_n_f32(direction[d+1]));
                    r4c = vfmaq_f32(r4c, a2, a2); p4c = vfmaq_f32(p4c, x2, vdupq_n_f32(direction[d+2]));
                    r4d = vfmaq_f32(r4d, a3, a3); p4d = vfmaq_f32(p4d, x3, vdupq_n_f32(direction[d+3]));
                }
                for (; d < dimension; ++d) {
                ...
                r4 = vaddq_f32(vaddq_f32(r4, r4b), vaddq_f32(r4c, r4d));
                p4 = vaddq_f32(vaddq_f32(p4, p4b), vaddq_f32(p4c, p4d));
